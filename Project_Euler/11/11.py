# -*- coding: utf-8 -*-
problem = [[8,2,22,97,38,15,0,4,0,75,4,5,7,78,52,12,5,77,91,8],
...
for y in xrange(0,20):
    for x in xrange(0,20):
        try:
            problem_list.append(problem[y][x])
        except:
            break
...
for x in xrange(0,20):
    for y in xrange(0,20):
        try:
            problem_list.append(problem[x][y])
        except:
            break
    problem_list.append(0)
...
for x in xrange(0,20):
    for y in xrange(0,x):
        try:
            problem_list.append(problem[y][x-y])
        except:
            break
    problem_list.append(0)
...
answer = 0
for count in xrange(0,len(problem_list)-4):
    result = reduce(int.__mul__,problem_list[count:count+4])  
    if answer < result:
        answer = result
